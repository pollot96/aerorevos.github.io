...
function lightwhite(){
  ...
  document.getElementsByClassName("sitez-footer")[0].style.background = "white";
  for(let i=0;i<4;i++){
...
// document.getElementsByClassName("menu-test")[0].style.color="black";
// document.getElementsByClassName("menu-one")[0].style.color="black";
// document.getElementsByClassName("menu-one")[1].style.color="black";
...
function lightdark(){
  ...
  document.getElementsByClassName("sitez-footer")[0].style.background = "#26272b";
  document.getElementById("navbar").style.backgroundColor="#26272b";
  for(let i=0;i<4;i++){
    document.getElementsByClassName("navlink")[i].style.color="whitesmoke";
  }
